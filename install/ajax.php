...
";
			...
			$sqlInsertAdmin = "INSERT INTO `usuarios_admin` (`id_usuario_admin`, `nombre`, `email`, `password`, `date_created`) VALUES (NULL, '".$_REQUEST['admin_nombre']."', '".$_REQUEST['admin_email']."', '".Tools::md5($_REQUEST['admin_pass'])."', NOW())";
