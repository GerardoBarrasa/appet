		...
		<div class="container">
			<div class="row step-content__one squareBg">
				...
				<div class="col-sm-6">
					...
					<input type="text" name="nombre_proyecto" id="nombre_proyecto" class="form-control" value="" />
				</div>
				<div class="col-sm-6">
				...
				<div class="col-sm-4">
					...
					<input type="text" name="admin_nombre" id="admin_nombre" class="form-control" value="" />
				</div>
				<div class="col-sm-4">
					<label for="admin_email">Email administrador</label>
					<input type="text" name="admin_email" id="admin_email" class="form-control" value="" />
				</div>
				<div class="col-sm-4">
					<label for="admin_pass">Contraseña administrador</label>
					<input type="password" name="admin_pass" id="admin_pass" class="form-control" value="" />
				</div>
				<hr />
				<div class="clearfix"></div>
				<div class="col-12">
				...
				<div class="col-sm-3">
					...
					<input type="text" name="smtp_servidor" id="smtp_servidor" class="form-control" value="" />
				</div>
				<div class="col-sm-3">
					<label for="smtp_usuario">Usuario SMTP</label>
					<input type="text" name="smtp_usuario" id="smtp_usuario" class="form-control" value="" />
				</div>
				<div class="col-sm-3">
					<label for="smtp_pass">Contraseña SMTP</label>
					<input type="password" name="smtp_pass" id="smtp_pass" class="form-control" value="" />
				</div>
				<div class="col-sm-3">
				...
				<div class="col-sm-4">
					...
					<input type="text" name="dominio" id="dominio" class="form-control" value="" />
				</div>
				<div class="clearfix"></div>
				<div class="col-sm-3">
					<label for="bd_servidor">Host base de datos</label>
					<input type="text" name="bd_servidor" id="bd_servidor" class="form-control" value="" />
				</div>
				<div class="col-sm-3">
					<label for="bd_nombre">Nombre base de datos</label>
					<input type="text" name="bd_nombre" id="bd_nombre" class="form-control" value="" />
				</div>
				<div class="col-sm-3">
					<label for="bd_usuario">Usuario base de datos</label>
					<input type="text" name="bd_usuario" id="bd_usuario" class="form-control" value="" />
				</div>
				<div class="col-sm-3">
					<label for="bd_password">Contraseña base de datos</label>
					<input type="password" name="bd_password" id="bd_password" class="form-control" value="" />
				</div>
				<div class="col-12">
