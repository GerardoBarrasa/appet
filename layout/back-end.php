...
<head>
	...
	<script type="text/javascript">
		...
		const confirmDeleteTitle = "<?=l('admin-confirmar-eliminar-title');?>";
		const confirmDeleteText = "<?=l('admin-confirmar-eliminar-text');?>";
		const confirmDeleteOkBtn = "<?=l('admin-confirmar-eliminar-ok-btn');?>";
		const confirmDeleteCancelBtn = "<?=l('admin-confirmar-eliminar-cancel-btn');?>";
		const eliminarOkTitle = "<?=l('admin-eliminar-ok-title');?>";
		const eliminarOkText = "<?=l('admin-eliminar-ok-text');?>";
	</script>
