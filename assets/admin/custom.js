...
function ajax_get_perfiles( comienzo, limite, pagina )
{
    ...
    afetch(
        dominio+"adminajax/ajax-get-perfiles/",
        {
            method: 'POST',
            body: formData
        }
...
function confirmarEliminacion( id, modelo, callback = null ) 
{
    Swal.fire({
        ...
        confirmButtonText: confirmDeleteOkBtn,
        cancelButtonText: confirmDeleteCancelBtn
    })
    .then( eliminado => {
