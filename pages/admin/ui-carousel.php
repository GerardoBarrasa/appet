					...
					<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel" data-interval="3000">
						<div class="carousel-inner" role="listbox">
							<div class="carousel-item active">
								<img class="d-block img-fluid" src="<?=_ASSETS_._ADMIN_;?>images/demo/attach.jpg" alt="First slide">
							</div>
							<div class="carousel-item">
								<img class="d-block img-fluid" src="<?=_ASSETS_._ADMIN_;?>images/demo/attach.jpg" alt="Second slide">
							</div>
							<div class="carousel-item">
								<img class="d-block img-fluid" src="<?=_ASSETS_._ADMIN_;?>images/demo/attach.jpg" alt="Third slide">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="card m-b-20">
				<div class="card-body">
					...
					<div id="carouselExampleCaption" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner" role="listbox">
							<div class="carousel-item active">
								<img src="<?=_ASSETS_._ADMIN_;?>images/demo/attach.jpg" alt="..." class="d-block img-fluid">
