                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="<?=_ASSETS_._ADMIN_;?>dist/img/user4-128x128.jpg"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="active tab-pane" id="activity">
                                <div class="post">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm" src="<?=_ASSETS_._ADMIN_;?>dist/img/user1-128x128.jpg"
                                             alt="user image">
                                        <span class="username">
                      <a href="#">
                        Jonathan Burke Jr.
                      ...
                      <a href="#" class="link-black text-sm">
                        ...
                        Comments (5)
                                ...
                                <div class="post clearfix">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm" src="<?=_ASSETS_._ADMIN_;?>dist/img/user7-128x128.jpg"
                                             alt="User Image">
                                        <span class="username">
                      <a href="#">
                        Sarah Ross
                      ...
                      Sent you a message - 3 days ago
                                ...
                                <div class="post">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm" src="<?=_ASSETS_._ADMIN_;?>dist/img/user6-128x128.jpg"
                                             alt="User Image">
                                        <span class="username">
                      <a href="#">
                        Adam Jones
                      ...
                      Posted 5 photos - 5 days ago
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-6">
                                            <img class="img-fluid" src="<?=_ASSETS_._ADMIN_;?>dist/img/photo1.png" alt="Photo">
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <img class="img-fluid mb-3" src="<?=_ASSETS_._ADMIN_;?>dist/img/photo2.png" alt="Photo">
                                                    <img class="img-fluid" src="<?=_ASSETS_._ADMIN_;?>dist/img/photo3.jpg" alt="Photo">
                                                </div>
                                                <div class="col-sm-6">
                                                    <img class="img-fluid mb-3" src="<?=_ASSETS_._ADMIN_;?>dist/img/photo4.jpg" alt="Photo">
                                                    <img class="img-fluid" src="<?=_ASSETS_._ADMIN_;?>dist/img/photo1.png" alt="Photo">
                                                </div>
                                            </div>
                                        </div>
