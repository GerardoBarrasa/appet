	...
	<div class="row">
		...
		<div class="col-md-6 col-lg-6 col-xl-3">
			...
			<div class="card m-b-30">
				...
				<img class="img-fluid" src="<?=_ASSETS_._ADMIN_;?>images/demo/attach.jpg" alt="Card image cap">
				<div class="card-body">
					<p class="card-text">Some quick example text to build on the card title and make
						up the bulk of the card's content.</p>
					<a href="#" class="card-link">Card link</a>
	...
	<div class="row">
		...
		<div class="col-lg-4">
			<div class="card m-b-30">
				...
				<img class="card-img-bottom img-fluid" src="<?=_ASSETS_._ADMIN_;?>images/demo/attach.jpg" alt="Card image cap">
			</div>
		</div>

		<div class="col-lg-4">
			<div class="card m-b-30">
				<img class="card-img img-fluid" src="<?=_ASSETS_._ADMIN_;?>images/demo/attach.jpg" alt="Card image">
