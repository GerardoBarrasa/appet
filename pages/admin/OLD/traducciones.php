        ...
        <div class="page-title-box">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <a href="<?=_DOMINIO_._ADMIN_;?>regenerar-cache-traducciones/" class="btn btn-danger waves-effect waves-light"> <i class="fas fa-redo-alt"></i> Regenerar caché</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <p class="text-muted">Traducción al <?=$porcentajeTraduccionesPorIdioma[$idioma->id]?>%</p>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="busqueda" id="busqueda" value="" onkeyup="ajax_get_traductions_filtered('<?=$comienzo?>', '<?=$limite?>', '<?=$pagina?>');" placeholder="Busca un contenido..." class="form-control" />
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-3">
                                <label for="translation_status">Estado</label>
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <label for="id_lang">Idioma</label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="<?=_DOMINIO_._ADMIN_.'traduccion/new/';?>" name="form_new_traduction" id="form_new_traduction">
                            ...
                            <div class="form-group">
                                <label class="mb-0" for="input_shortcode">Shortcode</label>
                                <input type="text" name="shortcode" style="border: 1px solid #ccc;" value="" id="input_shortcode" class="form-control" placeholder="Ejemplo: header-usuario-logout">
                            </div>

                            <div class="form-group">
                                <label class="mb-0" for="input_texto">Texto</label>
                                <textarea name="texto" style="border: 1px solid #ccc;" id="input_texto" rows="5" class="form-control" placeholder="Especifica el texto para este idioma"></textarea>
                            </div>

                            <div class="text-right">
                                <button type="submit" class="btn btn-success" name="submitCrearTraduccion">Crear traducción</button>
                            </div>
                        </form>
                    </div>
                </div>
