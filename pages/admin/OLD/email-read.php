	...
	<div class="row">
		<div class="col-12">
			...
			<div class="email-leftbar card">
				<a href="email-compose.html" class="btn btn-danger btn-rounded btn-block waves-effect waves-light">Compose</a>
				...
				<div class="m-t-20">
					<a href="#" class="media">
						<img class="d-flex mr-3 rounded-circle" src="<?=_ASSETS_._ADMIN_;?>images/demo/user.jpg" alt="Generic placeholder image" height="36">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="media m-b-30">
							<img class="d-flex mr-3 rounded-circle thumb-md" src="<?=_ASSETS_._ADMIN_;?>images/demo/user.jpg" alt="Generic placeholder image">
						...
						<div class="row">
							<div class="col-xl-2 col-6">
								<div class="card m-b-20">
									<img class="card-img-top img-fluid" src="<?=_ASSETS_._ADMIN_;?>images/demo/attach.jpg" alt="Card image cap">
						...
						<a href="email-compose.html" class="btn btn-secondary waves-effect m-t-30"><i class="mdi mdi-reply"></i> Reply</a>
					</div>
