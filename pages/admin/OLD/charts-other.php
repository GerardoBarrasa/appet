				...
				<div class="card-body">
					...
					<div class="row text-center">
						<div class="col-lg-4 text-center">
							...
							<input class="knob" data-width="150" data-fgcolor="#f16c69" data-displayinput="false" value="35">
						</div>
						<div class="col-lg-4 text-center">
					...
					<div class="row">
						<div class="col-lg-4 text-center">
							...
							<input class="knob" data-width="150" data-angleoffset="90" data-linecap="round" data-fgcolor="#28bbe3" value="35">
						</div>
						<div class="col-lg-4 text-center">
