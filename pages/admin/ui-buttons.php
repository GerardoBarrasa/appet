		...
		<div class="col-lg-6">
			<div class="card m-b-30">
				<div class="card-body">
					...
					<p class="text-muted m-b-30 ">Replace the default modifier classes with
		...
		<div class="col-lg-6">
			<div class="card m-b-30">
				<div class="card-body">
					...
					<p class="text-muted m-b-30 ">The <code class="highlighter-rouge">.btn</code>
		...
		<div class="col-lg-6">
			<div class="card m-b-30">
				<div class="card-body">
					...
					<p class="text-muted m-b-30 ">Fancy larger or smaller buttons? Add
