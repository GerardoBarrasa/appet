		...
		<div class="col-lg-6">
			<div class="card m-b-20">
				<div class="card-body">
					...
					<p class="text-muted m-b-30 ">Badges scale to match the size of the
		...
		<div class="col-lg-6">
			<div class="card m-b-20">
				<div class="card-body">
					...
					<p class="text-muted m-b-30 ">Add any of the below mentioned modifier
					...
					<p class="text-muted m-b-30  m-t-40">Use the <code
