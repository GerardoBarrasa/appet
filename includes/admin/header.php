			...
			<li class="dropdown notification-list">
				<div class="dropdown notification-list nav-pro-img show">
					...
					<div class="dropdown-menu dropdown-menu-right profile-dropdown" x-placement="bottom-end">
						<a class="dropdown-item d-block" href="<?=_DOMINIO_._ADMIN_;?>usuario-admin/<?=$_SESSION['admin_panel']->id_usuario_admin;?>/"><i class="mdi mdi-account-key m-r-5"></i> <?=l('admin-perfil');?></a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item text-danger" href="<?=_DOMINIO_._ADMIN_;?>logout/"><i class="mdi mdi-power text-danger"></i> <?=l('admin-logout');?></a>
					</div>
				</div>
			</li>
		</ul>
